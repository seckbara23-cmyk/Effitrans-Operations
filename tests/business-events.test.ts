...
// MAYA-P0.7-A — the recevabilité decision (Quality Control N°3). An RPC rather
...
// TRANSIT-CUSTODY-05 — the BAE/release split emits its own two facts.
const TC5_RELEASE_APPROVAL = "supabase/migrations/20260930000001_customs_release_approval.sql";
