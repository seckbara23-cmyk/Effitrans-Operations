...
const ACTIVITY_META: Record<string, ActivityMeta> = {
  ...
  "tracking.event.created": { label: "Suivi mis à jour", category: "transport", financeSensitive: false },
  "tracking.delay.reported": { label: "Retard signalé", category: "transport", financeSensitive: false },
  "tracking.incident.reported": { label: "Incident signalé", category: "transport", financeSensitive: false },
  "tracking.position.manual_recorded": { label: "Position manuelle enregistrée", category: "transport", financeSensitive: false },
