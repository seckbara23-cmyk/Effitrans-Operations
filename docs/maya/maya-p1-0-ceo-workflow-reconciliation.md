...
| 8 GAINDE | Service Finance | 8–9 `coordinator_to_finance`, `gainde_registration` | `customs_record.external_ref` + `gainde_registered_at/_by` · `recordGaindeRegistration` / `record_gainde_registration` · **`customs:register`** | **A** ✅ | **CLOSED by MAYA-P1.1** (migration 105). ⚠ **PARTIALLY REOPENED 2026-09-06 (DEC-C37/C39):** what shipped records a REFERENCE; Effitrans has since ratified that this step is the GAINDE registration **with the duties and taxes, as an actual payment with a per-line breakdown**. The act is owned correctly; its CONTENT is incomplete. This row also carried a contradiction — class **A** here and « BLOCKED BY OWNERSHIP » in the class list — kept visible |
| 9 Rattachement | Déclarant | **11** `gainde_document_submission` | `customs_record.attachment_completed_at/_by`, `attachment_systems` · `record_customs_attachment` | **A** | ⚠ **RATIFIED 2026-09-06 (DEC-C40).** Was **F**, « 10–11 », « undefined as a durable fact » — closed by MAYA-P1.11 (migration `20260828000001`), which made the rattachement a durable fact on step 11. The « 10–11 » straddle in this row is the ORIGIN of the step-10/step-11 ambiguity; kept visible rather than deleted |
