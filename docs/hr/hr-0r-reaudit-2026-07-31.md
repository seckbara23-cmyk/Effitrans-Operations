...
| **Governance ratification (2026-07-31)**: HR-0R/0A approved + eleven additions — configuration center, five-level HR hierarchy, engine-controlled states with configurable presentation, the `hr_employee_event` Timeline ledger, equipment promoted, integration extension points, Dashboard-first HR-1, the renumbered HR-1…HR-9 roadmap, and the « HR Platform » charter | [hr-governance-addendum-2026-07-31.md](hr-governance-addendum-2026-07-31.md) |
