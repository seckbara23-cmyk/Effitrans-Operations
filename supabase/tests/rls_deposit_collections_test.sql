...
insert into public.invoice (id, tenant_id, file_id, client_id, status) values
  ('00000000-0000-0000-0000-00000000db01', '00000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-00000000daf1', '00000000-0000-0000-0000-00000000dac1', 'VALIDATED'),
  ('00000000-0000-0000-0000-00000000db02', '00000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-00000000daf2', '00000000-0000-0000-0000-00000000dac1', 'VALIDATED'),
  ('00000000-0000-0000-0000-00000000db03', '00000000-0000-0000-0000-0000000000b2', '00000000-0000-0000-0000-00000000daf3', '00000000-0000-0000-0000-00000000dac2', 'VALIDATED')
on conflict (id) do nothing;
...
insert into public.invoice_deposit (id, tenant_id, file_id, invoice_id, status, courier_user_id) values
  ('00000000-0000-0000-0000-00000000dad1', '00000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-00000000daf1', '00000000-0000-0000-0000-00000000db01', 'ASSIGNED', '00000000-0000-0000-0000-0000000da002'),
  ('00000000-0000-0000-0000-00000000dad2', '00000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-00000000daf2', '00000000-0000-0000-0000-00000000db02', 'ASSIGNED', '00000000-0000-0000-0000-0000000da003'),
  ('00000000-0000-0000-0000-00000000dad3', '00000000-0000-0000-0000-0000000000b2', '00000000-0000-0000-0000-00000000daf3', '00000000-0000-0000-0000-00000000db03', 'ASSIGNED', null)
on conflict (id) do nothing;

insert into public.collection_follow_up (id, tenant_id, file_id, invoice_id, channel, outcome, note) values
  ('00000000-0000-0000-0000-00000000dcf1', '00000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-00000000daf1', '00000000-0000-0000-0000-00000000db01', 'PHONE', 'PROMISE_TO_PAY', 'Relance 1'),
  ('00000000-0000-0000-0000-00000000dcf3', '00000000-0000-0000-0000-0000000000b2', '00000000-0000-0000-0000-00000000daf3', '00000000-0000-0000-0000-00000000db03', 'PHONE', 'NO_ANSWER', 'Relance B')
on conflict (id) do nothing;
...
begin
  ...
  begin
    ...
    values ('00000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-00000000daf1',
            '00000000-0000-0000-0000-00000000db01', '00000000-0000-0000-0000-0000000da006');
