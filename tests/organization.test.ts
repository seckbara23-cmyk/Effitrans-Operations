...
describe("5-9 — role-to-department mapping follows the confirmed business decisions", () => {
  ...
  it("TMS-5C moved EXACTLY three roles — every other mapping is byte-stable", () => {
    ...
    const expected: Record<string, string | null> = {
      ...
      CUSTOMS_FIELD_AGENT: "TRANSIT",
      // H-7 (2026-09-03): QUOTATION_MANAGER left TRANSIT. Its TRANSIT mapping was
      // marked PROVISIONAL on a reading of the Guide's T1 « cotation »; DEC-C32
      // places quotation validation under OPS_SUPERVISOR and the commercial
      // cotation reaches Operations with the client's request.
