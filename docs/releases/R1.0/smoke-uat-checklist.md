...
| D2 | Aging preview **visual sign-off** recorded (checklist in `docs/finance/aging/preview-runbook.md` §4) | Finance Manager | 🔄 **IN PROGRESS 2026-08-01** — FND-R11-01 resolved by **Option B**: preview `qrotqyaaugyzgljcwcpg` provisioned (72/72, dataset loaded, Q-01 data check ✔). Remaining: reviewer login → Preview env vars → preview build → V1–V8 → sign-off. Guide: [`../R1.1/d2-preview-execution.md`](../R1.1/d2-preview-execution.md) |
