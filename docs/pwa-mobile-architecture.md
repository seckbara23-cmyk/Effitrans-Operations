...
| Offline fallback | `app/offline/page.tsx` | static (build-verified `○`), public (middleware-exempt), honest copy; since the 2026-08-09 false-offline incident it SELF-RECOVERS (inline probe of `/api/version`, reload on real success, `navigator.onLine` as copy hint only) — see [incidents/2026-08-09-false-offline.md](incidents/2026-08-09-false-offline.md) |
