...
insert into public.client (id, tenant_id, name) values
  ('00000000-0000-0000-0000-0000000dac1', '00000000-0000-0000-0000-000000000001', 'D Client A'),
  ('00000000-0000-0000-0000-0000000dac2', '00000000-0000-0000-0000-0000000000b2', 'D Client B')
on conflict (id) do nothing;

insert into public.operational_file (id, tenant_id, file_number, type, client_id) values
  ('00000000-0000-0000-0000-0000000daf1', '00000000-0000-0000-0000-000000000001', 'EFT-IMP-2099-95001', 'IMP', '00000000-0000-0000-0000-0000000dac1'),
  ('00000000-0000-0000-0000-0000000daf2', '00000000-0000-0000-0000-000000000001', 'EFT-IMP-2099-95002', 'IMP', '00000000-0000-0000-0000-0000000dac1'),
  ('00000000-0000-0000-0000-0000000daf3', '00000000-0000-0000-0000-0000000000b2', 'EFT-IMP-2099-95003', 'IMP', '00000000-0000-0000-0000-0000000dac2')
on conflict (id) do nothing;

insert into public.invoice (id, tenant_id, file_id, client_id, status) values
  ('00000000-0000-0000-0000-0000000dai1', '00000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-0000000daf1', '00000000-0000-0000-0000-0000000dac1', 'VALIDATED'),
  ('00000000-0000-0000-0000-0000000dai2', '00000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-0000000daf2', '00000000-0000-0000-0000-0000000dac1', 'VALIDATED'),
  ('00000000-0000-0000-0000-0000000dai3', '00000000-0000-0000-0000-0000000000b2', '00000000-0000-0000-0000-0000000daf3', '00000000-0000-0000-0000-0000000dac2', 'VALIDATED')
on conflict (id) do nothing;
...
insert into public.invoice_deposit (id, tenant_id, file_id, invoice_id, status, courier_user_id) values
  ('00000000-0000-0000-0000-0000000dad1', '00000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-0000000daf1', '00000000-0000-0000-0000-0000000dai1', 'ASSIGNED', '00000000-0000-0000-0000-0000000da002'),
  ('00000000-0000-0000-0000-0000000dad2', '00000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-0000000daf2', '00000000-0000-0000-0000-0000000dai2', 'ASSIGNED', '00000000-0000-0000-0000-0000000da003'),
  ('00000000-0000-0000-0000-0000000dad3', '00000000-0000-0000-0000-0000000000b2', '00000000-0000-0000-0000-0000000daf3', '00000000-0000-0000-0000-0000000dai3', 'ASSIGNED', null)
on conflict (id) do nothing;

insert into public.collection_follow_up (id, tenant_id, file_id, invoice_id, channel, outcome, note) values
  ('00000000-0000-0000-0000-0000000dcf1', '00000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-0000000daf1', '00000000-0000-0000-0000-0000000dai1', 'PHONE', 'PROMISE_TO_PAY', 'Relance 1'),
  ('00000000-0000-0000-0000-0000000dcf3', '00000000-0000-0000-0000-0000000000b2', '00000000-0000-0000-0000-0000000daf3', '00000000-0000-0000-0000-0000000dai3', 'PHONE', 'NO_ANSWER', 'Relance B')
on conflict (id) do nothing;
...
begin
  ...
  select count(*) into c1_own from public.invoice_deposit where id = '00000000-0000-0000-0000-0000000dad1';
  select count(*) into c1_other from public.invoice_deposit where id = '00000000-0000-0000-0000-0000000dad2';
...
begin
  ...
  begin
    ...
    values ('00000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-0000000daf1',
            '00000000-0000-0000-0000-0000000dai1', '00000000-0000-0000-0000-0000000da006');
  ...
  begin
    ...
    values ('00000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-0000000daf2',
            'PROOF_OF_DEPOSIT', 'x/y/z.pdf', 'APPROVED')
    returning id into doc_id;

    update public.invoice_deposit
      set proof_document_id = doc_id
      where id = '00000000-0000-0000-0000-0000000dad1';  -- dad1 is on daf1, doc is on daf2
  ...
  begin
    update public.invoice
      ...
      where id = '00000000-0000-0000-0000-0000000dai1';
  ...
  begin
    update public.collection_follow_up
      set note = 'rewritten'
      where id = '00000000-0000-0000-0000-0000000dcf1';
