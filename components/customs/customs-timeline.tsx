...
import { buildCustomsTimeline, type CustomsRecord } from "@/lib/customs";
...
export function CustomsTimeline({ file }: { file: CustomsRecord }) {
  const steps = buildCustomsTimeline(file);
