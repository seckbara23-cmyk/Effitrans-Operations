...
insert into public.operational_file (id, tenant_id, file_number, type, client_id) values
  ('00000000-0000-0000-0000-00000000fh01', '00000000-0000-0000-0000-000000000001', 'EFT-IMP-2099-97001', 'IMP', '00000000-0000-0000-0000-00000000c2a0')
on conflict (id) do nothing;
...
insert into public.task (id, tenant_id, file_id, title, status, handoff_type, created_by) values
  ('00000000-0000-0000-0000-00000000th01', '00000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-00000000fh01',
...
begin
  ...
  begin
    ...
    values ('00000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-00000000fh01',
  ...
  select count(*) into ops_sees from public.task where id = '00000000-0000-0000-0000-00000000th01';
  ...
  select count(*) into dec_sees from public.task where id = '00000000-0000-0000-0000-00000000th01';
