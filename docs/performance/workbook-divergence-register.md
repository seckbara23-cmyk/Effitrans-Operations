...
| --- | --- | --- | --- | --- |
| DV-01 | 🔴 | **CDP has a 5th declaration type `DPE = 1,30`** in the workbook (PARAMETRES E5:F5, LISTES D5). The methodology (§5.2) lists exactly four: SIMPLE/APE/DEP/OG | ICTD PARAMETRES E2:F6 | **Q1** — ratify DPE (and confirm DEP and DPE are genuinely two types, not a spelling drift: legacy has DPE=1,40 and **no DEP**) |
...
| DV-09 | 🔴 | CDP: `SIMPLE 1 · APE 1,4 · DPE 1,4 · OG 1,5` — **no DEP; DPE = 1,40** | SIMPLE 1 · APE 1,4 · DEP 1,3 · DPE 1,3 · OG 1,5 (→ feeds Q1) |
